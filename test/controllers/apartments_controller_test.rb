...
class ApartmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create apartment" do
    assert_difference("Apartment.count") do
      post apartments_url, params: { apartment: { area: @apartment.area, fragmented: @apartment.fragmented, name: @apartment.name, number: @apartment.number, prefix: @apartment.prefix } }
    end
  ...
  test "should update apartment" do
    patch apartment_url(@apartment), params: { apartment: { area: @apartment.area, fragmented: @apartment.fragmented, name: @apartment.name, number: @apartment.number, prefix: @apartment.prefix } }
